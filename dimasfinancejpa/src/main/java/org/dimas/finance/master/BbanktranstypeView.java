...
public class BbanktranstypeView extends CustomComponent {
	private BbanktranstypeModel model;
	...
	public BbanktranstypeView(BbanktranstypeModel model){
		this.model = model;		
		initContainer();
		initFieldFactory();
		buildView();
...
//		comboGrup.setItemCaption("GRUP1", "Setoran");
		...
		comboGrup.setItemCaption("GRUP2", "Penerimaan Kas Bank");
		comboGrup.addItem("GRUP3");
		comboGrup.setItemCaption("GRUP3", "Pengeluaran Kas Bank");
		comboGrup.addItem("GRUP4");
		comboGrup.setItemCaption("GRUP4", "Mutasi Kas Kecil");
		comboGrup.addItem("GRUPL");
		comboGrup.setItemCaption("GRUPL", "Lain-lain");
		
		model.getBinderBbanktranstype().bind(fieldId, "id");
		model.getBinderBbanktranstype().bind(fieldDescription, "description");
		model.getBinderBbanktranstype().bind(comboGrup, "grup");
		model.getBinderBbanktranstype().bind(comboAccount, "accountBean");
...
//		addButton.setEnabled(false);
	...
	public BbanktranstypeModel getModel() {
		return model;
	}
	public void setModel(BbanktranstypeModel model) {
		this.model = model;
	}
