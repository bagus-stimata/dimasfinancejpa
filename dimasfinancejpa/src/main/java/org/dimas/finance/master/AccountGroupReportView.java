...
public class AccountGroupReportView extends CustomComponent {
	private AccountGroupReportModel model;
	private VerticalLayout content = new VerticalLayout();

//	private JPAContainer<AccountGroupReport> container;
	...
	private Class<Accountgroupreport> entityClass;
...
//	private BeanItem<AccountGrup> beanItemAccountGrup;
	...
	public AccountGroupReportView(AccountGroupReportModel model){
		this.model = model;		
		initContainer();
		initFieldFactory();
		buildView();
...
//			}
	...
	public AccountGroupReportModel getModel() {
		return model;
	}
	public void setModel(AccountGroupReportModel model) {
		this.model = model;
	}
