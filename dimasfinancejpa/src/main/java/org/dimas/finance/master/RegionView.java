...
public class RegionView extends CustomComponent {
...
//	private BeanItem<AccountGrup> beanItemAccountGrup;
	...
	public RegionView(RegionModel model){
		this.model = model;		
		initContainer();
		initFieldFactory();
		buildView();
...
//		table.addActionHandler(this);		
	...
	public void setTableProperties(){
		setVisibleTableProperties("id","region");
		//set header
		table.setColumnHeader("id", "ID");
		table.setColumnHeader("region", "REGION");
		
		table.setColumnExpandRatio("id", 1);
		table.setColumnExpandRatio("region", 3);		
	}
	public void setFormProperties(){
		setVisibleFormProperties("id", "region");
	}
...
//			final JPAContainer<AccountGrup> grupJPAContainer = JPAContainerFactory.make(AccountGrup.class, PERSISTENCE_UNIT);
			...
			if ("id".equals(propertyId)) {
				...
				return field;
			} else if ("region".equals(propertyId)) {
				field = new TextField("REGION: ");
				field.setRequired(true);
