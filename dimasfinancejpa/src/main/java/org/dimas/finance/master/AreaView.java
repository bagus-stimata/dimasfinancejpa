...
public class AreaView extends CustomComponent {
	private AreaModel model;
	private VerticalLayout content = new VerticalLayout();

//	private JPAContainer<Area> container;
	...
	private Class<Area> entityClass;
...
//		table.addActionHandler(this);		
	...
	public void setTableProperties(){
		setVisibleTableProperties("id","area", "regionBean");
		//set header
		table.setColumnHeader("id", "ID");
		table.setColumnHeader("area", "AREA");
		table.setColumnHeader("regionBean", "REGION");
		
		table.setColumnExpandRatio("id", 1);
		table.setColumnExpandRatio("area", 2);		
		table.setColumnExpandRatio("regionBean", 3);		
	}
	public void setFormProperties(){
		setVisibleFormProperties("id", "area", "regionBean");
	}
...
//			final JPAContainer<AccountGrup> grupJPAContainer = JPAContainerFactory.make(AccountGrup.class, PERSISTENCE_UNIT);
			...
			if ("id".equals(propertyId)) {
				...
				field = new TextField("AREA: ");
				field.setRequired(true);
				field.setRequiredError("Area tidak boleh kosong");
