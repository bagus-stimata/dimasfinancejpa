...
public class PenerimaanBankItemAddPresenter implements ClickListener{
	private PenerimaanBankItemAddModel model;
	private PenerimaanBankItemAddView view;
	
	public PenerimaanBankItemAddPresenter(PenerimaanBankItemAddModel model, PenerimaanBankItemAddView view){
		this.model = model;
		this.view = view;
