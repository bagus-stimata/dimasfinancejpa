...
public class PengeluaranBankItemAddView extends CustomComponent {
	/**
	 * 
	 */
...
//	private TextField fieldSearchByTitle = new TextField("TITLE");
	...
	public PengeluaranBankItemAddView(PengeluaranBankItemAddModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		formLayoutHorizontal.addComponent(btnClose);
	...
	public PengeluaranBankItemAddModel getModel() {
		return model;
	}
	public void setModel(PengeluaranBankItemAddModel model) {
		this.model = model;
	}
