...
public class GiroBlongView extends CustomComponent{
	...
	public GiroBlongView(GiroBlongModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public GiroBlongModel getModel() {
		return model;
	}

	public void setModel(GiroBlongModel model) {
		this.model = model;
	}
