...
public class PengeluaranBankHeaderSelectView extends CustomComponent {
...
//	private TextField fieldSearchByTemplateName = new TextField("Template Name");
	...
	public PengeluaranBankHeaderSelectView(PengeluaranBankHeaderSelectModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public PengeluaranBankHeaderSelectModel getModel() {
		return model;
	}
	public void setModel(PengeluaranBankHeaderSelectModel model) {
		this.model = model;
	}
