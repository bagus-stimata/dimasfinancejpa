...
public class PenerimaanBankPresenter implements ClickListener, ValueChangeListener{
	private PenerimaanBankModel model;
	private PenerimaanBankView view;
	
	public PenerimaanBankPresenter(PenerimaanBankModel model, PenerimaanBankView view){
		this.model = model;
		this.view =	view;
...
//			fixItemOnTableDetail();
	...
	public static void main(String args []){
		PenerimaanBankModel model = new PenerimaanBankModel();
		PenerimaanBankView view = new PenerimaanBankView(model);
		PenerimaanBankPresenter f = new PenerimaanBankPresenter(model, view);
