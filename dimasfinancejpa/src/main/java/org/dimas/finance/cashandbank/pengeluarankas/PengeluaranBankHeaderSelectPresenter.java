...
public class PengeluaranBankHeaderSelectPresenter implements ClickListener, ValueChangeListener{
	private PengeluaranBankHeaderSelectModel model;
	private PengeluaranBankHeaderSelectView view;
	
	public PengeluaranBankHeaderSelectPresenter(PengeluaranBankHeaderSelectModel model, PengeluaranBankHeaderSelectView view){
		this.model = model;
		this.view = view;
