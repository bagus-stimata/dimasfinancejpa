...
public class PengeluaranBankView extends CustomComponent{
	...
	public PengeluaranBankView(PengeluaranBankModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	private PengeluaranBankHeaderSelectModel headerSelectModel; 
	private PengeluaranBankHeaderSelectView headerSelectView;
	...
	public void buildWindowHeaderSelect(){
		...
		headerSelectModel = new PengeluaranBankHeaderSelectModel();
		headerSelectView = new PengeluaranBankHeaderSelectView(headerSelectModel);
		
		PengeluaranBankHeaderSelectPresenter modulTempHeaderSelectPresenter = new PengeluaranBankHeaderSelectPresenter(
	...
	private PengeluaranBankItemAddModel itemAddModel; 
	private PengeluaranBankItemAddView itemAddView;
	private PengeluaranBankItemAddPresenter itemAddPresenter;
	...
	public void buildWindowItemAdd(String operationStatus){
		...
		//INITIAL DATA TO PASS		
		itemAddModel = new PengeluaranBankItemAddModel();
		...
		itemAddView = new PengeluaranBankItemAddView(itemAddModel);
		
		itemAddPresenter = new PengeluaranBankItemAddPresenter(
...
//		System.out.println( model.getOperationStatus() + "\t" + comboDivision.getValue() + "\t" + div + "\t" + strDiv + "\t" + refno);
	...
	public PengeluaranBankModel getModel() {
		return model;
	}

	public void setModel(PengeluaranBankModel model) {
		this.model = model;
	}
	...
	public PengeluaranBankHeaderSelectModel getHeaderSelectModel() {
		return headerSelectModel;
	}

	public void setHeaderSelectModel(
			PengeluaranBankHeaderSelectModel headerSelectModel) {
		this.headerSelectModel = headerSelectModel;
	}

	public PengeluaranBankHeaderSelectView getHeaderSelectView() {
		return headerSelectView;
	}

	public void setHeaderSelectView(PengeluaranBankHeaderSelectView headerSelectView) {
	...
	public PengeluaranBankItemAddModel getItemAddModel() {
		return itemAddModel;
	}

	public void setItemAddModel(PengeluaranBankItemAddModel itemAddModel) {
		this.itemAddModel = itemAddModel;
	}

	public PengeluaranBankItemAddView getItemAddView() {
		return itemAddView;
	}

	public void setItemAddView(PengeluaranBankItemAddView itemAddView) {
		this.itemAddView = itemAddView;
	}

	public PengeluaranBankItemAddPresenter getItemAddPresenter() {
		return itemAddPresenter;
	}

	public void setItemAddPresenter(PengeluaranBankItemAddPresenter itemAddPresenter) {
