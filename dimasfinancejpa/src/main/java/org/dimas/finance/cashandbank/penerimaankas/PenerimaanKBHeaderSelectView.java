...
public class PenerimaanKBHeaderSelectView extends CustomComponent {
...
//	private TextField fieldSearchByTemplateName = new TextField("Template Name");
	...
	public PenerimaanKBHeaderSelectView(PenerimaanKBHeaderSelectModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		formLayoutHorizontal.setSpacing(true);
	...
	public void setDisplay(){
		//TABLE
		table.setContainerDataSource(model.getBeanItemContainerBkbHeader());
	...
	public void setDisplayTableFooter(){
		Collection items =  model.getBeanItemContainerBkbHeader().getItemIds();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public PenerimaanKBHeaderSelectModel getModel() {
		return model;
	}
	public void setModel(PenerimaanKBHeaderSelectModel model) {
		this.model = model;
	}
