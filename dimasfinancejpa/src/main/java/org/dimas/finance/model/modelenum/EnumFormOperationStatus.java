package org.dimas.finance.model.modelenum;

public enum EnumFormOperationStatus {
    ...
    private EnumFormOperationStatus(int intCode, String strCode, String description){
