...
@Entity
@Table(name="BKKBALANCE")
public class Bkkbalance implements Serializable{
	@EmbeddedId
	private BkkbalancePK id;
	...
	public BkkbalancePK getId() {
		return id;
	}
	public void setId(BkkbalancePK id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Bkkbalance other = (Bkkbalance) obj;
		if (id == null) {
			if (other.id != null)
				return false;
