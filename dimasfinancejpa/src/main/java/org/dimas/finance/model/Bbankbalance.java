...
@Entity
@Table(name="BBANKBALANCE")
public class Bbankbalance implements Serializable{
	@EmbeddedId
	private BbankbalancePK id;
	...
	public BbankbalancePK getId() {
		return id;
	}
	public void setId(BbankbalancePK id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Bbankbalance other = (Bbankbalance) obj;
		if (id == null) {
			if (other.id != null)
				return false;
