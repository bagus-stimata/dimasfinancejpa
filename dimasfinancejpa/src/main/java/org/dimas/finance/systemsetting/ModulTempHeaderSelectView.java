...
public class ModulTempHeaderSelectView extends CustomComponent {
	...
	private Button btnSelect = new Button("Select All Selected");
	...
	public ModulTempHeaderSelectView(ModulTempHeaderSelectModel model){
		this.model = model;
		initComponent();
		buildView();
	...
	public void buildView(){
		...
		layoutTop.addComponent(fieldSearchByTemplateName);
...
//		formLayoutHorizontal.setSpacing(true);
	...
	public void setDisplay(){
		//TABLE
		table.setContainerDataSource(model.getBeanItemContainerModulTempHeader());
	...
	public void setDisplayTableFooter(){
		Collection items =  model.getBeanItemContainerModulTempHeader().getItemIds();
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "templateName", 
				"notes", "createTime");
...
//		table.setColumnAlignment("id", Align.CENTER);
		table.setColumnAlignment("createTime", Align.CENTER);
		
		//SET HEADER
		table.setColumnHeader("id", "ID");
		table.setColumnHeader("templateName", "NAMA TEMPLATE");
		table.setColumnHeader("notes", "CATATAN");
		table.setColumnHeader("createTime", "WAKTU DIBUAT");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public ModulTempHeaderSelectModel getModel() {
		return model;
	}
	public void setModel(ModulTempHeaderSelectModel model) {
		this.model = model;
	}
	...
	public TextField getFieldSearchByTemplateName() {
		return fieldSearchByTemplateName;
	}
	public void setFieldSearchByTemplateName(TextField fieldSearchByTemplateName) {
		this.fieldSearchByTemplateName = fieldSearchByTemplateName;
	}
