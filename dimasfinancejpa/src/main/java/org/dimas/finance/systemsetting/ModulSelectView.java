...
public class ModulSelectView extends CustomComponent {
	...
	public ModulSelectView(ModulSelectModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		formLayoutHorizontal.setSpacing(true);
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("selected", "id", "modulGroup", 
				"title", "notes");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public ModulSelectModel getModel() {
		return model;
	}
	public void setModel(ModulSelectModel model) {
		this.model = model;
	}
