...
//	private String operationStatus;
	...
	private BeanItemContainer<SysCalenderPekan> beanItemContainerPekan;
	...
	public void initVariable(){
		...
		beanItemContainerPekan = new BeanItemContainer<SysCalenderPekan>(SysCalenderPekan.class);
...
//		tableBeanItemContainer.addAll(sysCalenderService.findAll());
	...
	public BeanItemContainer<SysCalenderPekan> getBeanItemContainerPekan() {
		return beanItemContainerPekan;
	}

	public void setBeanItemContainerPekan(
			BeanItemContainer<SysCalenderPekan> beanItemContainerPekan) {
		this.beanItemContainerPekan = beanItemContainerPekan;
	}
