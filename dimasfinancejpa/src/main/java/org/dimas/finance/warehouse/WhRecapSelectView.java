...
import org.dimas.finance.cashandbank.penerimaankas.PenerimaanKBHeaderSelectModel;
import org.dimas.finance.cashandbank.penerimaankas.PenerimaanKBHeaderSelectPresenter;
import org.dimas.finance.cashandbank.penerimaankas.PenerimaanKBHeaderSelectView;
...
public class WhRecapSelectView extends CustomComponent {
...
//	private TextField fieldSearchByTemplateName = new TextField("Template Name");
	...
	public WhRecapSelectView(WhRecapSelectModel model){
		this.model = model;
		initComponent();
		buildView();
...
//		formLayoutHorizontal.setSpacing(true);
	...
	public void setDisplayTableFooter(){
		...
		table.setColumnFooter("recapno", "*Jumlah Record: " + items.size());
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public WhRecapSelectModel getModel() {
		return model;
	}
	public void setModel(WhRecapSelectModel model) {
		this.model = model;
	}
