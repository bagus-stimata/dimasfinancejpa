...
package org.dimas.finance.report;
...
import org.dimas.finance.data.Generator;
import org.dimas.finance.util.HelpManager;
import org.dimas.finance.DashboardUI;
    ...
    private Component buildDraftsView() {
      ...
      //Petama
        ...
        Label draftTitle = new Label(
                "L/R<br><span>Laporan Laba Rugi</span>",
                ContentMode.HTML);
...
//                  autoCreate(0, null, null);
                    ...
                    editors.addTab(createEditorInstance(0, null, null))
                            .setClosable(true);
      ...
      //Kedua
      CssLayout draftThumb2 = new CssLayout();
      draftThumb2.addStyleName("draft-thumb");
      Image draft2 = new Image(null, new ThemeResource(
              "img/draft-report-thumb.png"));
      draftThumb2.addComponent(draft2);
      Label draftTitle2 = new Label(
              "Neraca<br><span>Laporan Neraca</span>",
              ContentMode.HTML);
      draftTitle2.setSizeUndefined();
      draftThumb2.addComponent(draftTitle2);
      drafts.addComponent(draftThumb2);
      // TODO layout bug, we need to set the alignment also for the first
      // child
      drafts.setComponentAlignment(draftThumb2, Alignment.MIDDLE_CENTER);

      final Button delete2 = new Button("×");
      delete2.setPrimaryStyleName("delete-button");
      draftThumb2.addComponent(delete2);
      delete2.addClickListener(new ClickListener() {
          @Override
          public void buttonClick(ClickEvent event) {
              Notification.show("Not implemented in this demo");
          }
            ...
            draftThumb2.addLayoutClickListener(new LayoutClickListener() {
          @Override
          public void layoutClick(LayoutClickEvent event) {
              if (event.getButton() == MouseButton.LEFT
                      && event.getChildComponent() != delete) {
...
//            helpShown = true;
        ...
        if (which == 1) {
        	...
        	editor.setCaption("This Is Else");
