...
//		List<Arinvoice> listArInvoice = new ArrayList<Arinvoice>();
//		listArInvoice = arInvoiceService.findAll();
//		for (Arinvoice item: listArInvoice){
//			ArInvoiceSelected itemSelected = new ArInvoiceSelected();
//			itemSelected = convertArInvoiceToSelected(item);			
//			itemSelected.getSelected().setValue(false);
//			
//			
//			tableList.add(itemSelected);
//		}
//		tableBeanItemContainer.addAll(tableList);
