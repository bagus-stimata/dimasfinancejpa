...
public class JatuhTempoManualView extends CustomComponent {
	...
	private Button btnSetTunai = new Button("TUNAI");
	private Button btnSetKredit = new Button("KREDIT");

	private TextField fieldOverdue = new TextField("TOP");	
	...
	public JatuhTempoManualView(JatuhTempoManualModel model){
		this.model = model;
		initComponent();
		initFieldFactory();
		buildView();
...
//		discard = new Button("Cancel");
	...
	public void buildView(){
		...
		layoutTopInner.addComponent(fieldOverdue);
...
//		setVisibleFormProperties("arinvoicePK.id");
	...
	public void setDisplaySearchComponent(){
		...
		//DEFAULT VIEW
		fieldSearchComboTunaiKredit.select("K");
...
//			fieldAmountPaySum.setReadOnly(true);
	...
	public JatuhTempoManualModel getModel() {
		return model;
	}

	public void setModel(JatuhTempoManualModel model) {
		this.model = model;
	}
	...
	public TextField getFieldOverdue() {
		return fieldOverdue;
	}

	public void setFieldOverdue(TextField fieldOverdue) {
		this.fieldOverdue = fieldOverdue;
	}
