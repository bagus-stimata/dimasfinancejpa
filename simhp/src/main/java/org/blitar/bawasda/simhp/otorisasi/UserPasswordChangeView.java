...
public class UserPasswordChangeView extends CustomComponent {
	...
	private Button btnCancelForm= new Button("Batal & Tutup");
...
//		layoutTop.addComponent(fieldSearchByNasabah);
	...
	public void initComponentFistState(){
		//init
		layoutTop.setVisible(false);
		panelTabel.setVisible(false);
		verticalSplitPanel.setSplitPosition(0);

		dateFieldJoinDate.setVisible(false);
		dateFieldLastLogin.setVisible(false);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		comboOtorize.setItemCaption(EnumUserOtorize.ADMINISTRATOR.getStrCode(), "Administrator");
		comboOtorize.addItem(EnumUserOtorize.USER1.getStrCode());
		comboOtorize.setItemCaption(EnumUserOtorize.USER1.getStrCode(), "User Top");
		comboOtorize.addItem(EnumUserOtorize.USER2.getStrCode());
		comboOtorize.setItemCaption(EnumUserOtorize.USER2.getStrCode(), "User Mengengah");
		comboOtorize.addItem(EnumUserOtorize.USER3.getStrCode());
		comboOtorize.setItemCaption(EnumUserOtorize.USER3.getStrCode(), "User Bawah");
