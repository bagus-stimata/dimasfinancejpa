...
public class TabelTindakLanjutView extends CustomComponent{
	...
	public TabelTindakLanjutView(TabelTindakLanjutModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		layoutTop.setComponentAlignment(fieldSearchByRefno, Alignment.BOTTOM_CENTER);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		model.getBinderHeader().bind(comboGrup, "tindakLanjutGrupBean");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "tindakLanjutGrupBean", 
				"statusActive");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("tindakLanjutGrupBean", "GRUP");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelTindakLanjutModel getModel() {
		return model;
	}

	public void setModel(TabelTindakLanjutModel model) {
		this.model = model;
	}
