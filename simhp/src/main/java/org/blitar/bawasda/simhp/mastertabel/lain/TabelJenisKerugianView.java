...
public class TabelJenisKerugianView extends CustomComponent{
	private TabelJenisKerugianModel model;
	...
	private TextField fieldDescription= new TextField("JENIS KERUGIAN");
	...
	private TextField fieldSearchByDesc = new TextField("JENIS KERUGIAN");
	...
	public TabelJenisKerugianView(TabelJenisKerugianModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		comboGrup.setNullSelectionAllowed(false);
		...
		model.getBinderHeader().bind(fieldReportDesc, "reportDesc");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "reportDesc", "statusActive");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("description", "JENIS KERUGIAN");
		table.setColumnHeader("reportDesc", "REPORT DESC");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelJenisKerugianModel getModel() {
		return model;
	}

	public void setModel(TabelJenisKerugianModel model) {
		this.model = model;
	}
