...
public class TabelTemuanKelompokView extends CustomComponent{
	...
	public TabelTemuanKelompokView(TabelTemuanKelompokModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelTemuanKelompokModel getModel() {
		return model;
	}

	public void setModel(TabelTemuanKelompokModel model) {
		this.model = model;
	}
