...
public class TabelPemeriksaanView extends CustomComponent{
	...
	public TabelPemeriksaanView(TabelPemeriksaanModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		layoutTop.setComponentAlignment(fieldSearchByRefno, Alignment.BOTTOM_CENTER);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		model.getBinderHeader().bind(comboGrup, "jenisPemeriksaanGrupBean");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "jenisPemeriksaanGrupBean", 
				"statusActive");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("jenisPemeriksaanGrupBean", "GRUP");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelPemeriksaanModel getModel() {
		return model;
	}

	public void setModel(TabelPemeriksaanModel model) {
		this.model = model;
	}
