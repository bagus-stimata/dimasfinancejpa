...
public class TabelPemeriksaanGrupView extends CustomComponent{
	...
	public TabelPemeriksaanGrupView(TabelPemeriksaanGrupModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelPemeriksaanGrupModel getModel() {
		return model;
	}

	public void setModel(TabelPemeriksaanGrupModel model) {
		this.model = model;
	}
