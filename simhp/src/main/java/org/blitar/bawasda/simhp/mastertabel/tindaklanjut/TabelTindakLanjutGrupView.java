...
public class TabelTindakLanjutGrupView extends CustomComponent{
	...
	public TabelTindakLanjutGrupView(TabelTindakLanjutGrupModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelTindakLanjutGrupModel getModel() {
		return model;
	}

	public void setModel(TabelTindakLanjutGrupModel model) {
		this.model = model;
	}
