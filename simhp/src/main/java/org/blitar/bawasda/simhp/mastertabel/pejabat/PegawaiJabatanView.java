...
public class PegawaiJabatanView extends CustomComponent{
	...
	private TextField fieldDescription= new TextField("JABATAN");
	...
	private TextField fieldSearchByDesc = new TextField("JABATAN");
	...
	public PegawaiJabatanView(PegawaiJabatanModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("description", "JABATAN");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public PegawaiJabatanModel getModel() {
		return model;
	}

	public void setModel(PegawaiJabatanModel model) {
		this.model = model;
	}
