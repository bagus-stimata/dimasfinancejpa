...
public class MataUangView extends CustomComponent{
	private MataUangModel model;
	...
	private TextField fieldDescription= new TextField("Singkatan");
	private TextField fieldDescriptionLong= new TextField("Nama Mata Uang");
	private TextField fieldNegaraAsal= new TextField("Negara Asal");
	...
	private TextField fieldSearchByDesc = new TextField("Singkatan");
	private TextField fieldSearchByDescLong = new TextField("Nama Mata Uang");
	...
	public MataUangView(MataUangModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
	...
	public void initComponent(){
		...
		fieldDescriptionLong.setNullRepresentation("");
		fieldNegaraAsal.setNullRepresentation("");
...
//		layoutTop.addComponent(comboSearchByGrup);
		...
		layoutTop.addComponent(fieldSearchByDescLong);
		...
		layoutTop.setComponentAlignment(fieldSearchByDescLong, Alignment.BOTTOM_CENTER);
...
//		formLayout.addComponent(comboGrup);
		...
		formLayout.addComponent(fieldDescriptionLong);
		formLayout.addComponent(fieldNegaraAsal);
...
//		comboGrup.setNullSelectionAllowed(false);
		...
		model.getBinderHeader().bind(fieldDescription, "shortName");
		model.getBinderHeader().bind(fieldDescriptionLong, "fullName");
		model.getBinderHeader().bind(fieldNegaraAsal, "negaraAsal");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "shortName", "fullName", "negaraAsal", "statusActive");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("shortName", "SINGKATAN");
		table.setColumnHeader("fullName", "MATA UANG");
		table.setColumnHeader("negaraAsal", "Negara Asal");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public MataUangModel getModel() {
		return model;
	}

	public void setModel(MataUangModel model) {
		this.model = model;
	}
	...
	public TextField getFieldDescriptionLong() {
		return fieldDescriptionLong;
	}

	public void setFieldDescriptionLong(TextField fieldDescriptionLong) {
		this.fieldDescriptionLong = fieldDescriptionLong;
	}

	public TextField getFieldNegaraAsal() {
		return fieldNegaraAsal;
	}

	public void setFieldNegaraAsal(TextField fieldNegaraAsal) {
		this.fieldNegaraAsal = fieldNegaraAsal;
	}
	...
	public TextField getFieldSearchByDescLong() {
		return fieldSearchByDescLong;
	}

	public void setFieldSearchByDescLong(TextField fieldSearchByDescLong) {
		this.fieldSearchByDescLong = fieldSearchByDescLong;
	}
