...
public class TabelRuangLingkupPemeriksaanView extends CustomComponent{
	...
	public TabelRuangLingkupPemeriksaanView(TabelRuangLingkupPemeriksaanModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelRuangLingkupPemeriksaanModel getModel() {
		return model;
	}

	public void setModel(TabelRuangLingkupPemeriksaanModel model) {
		this.model = model;
	}
