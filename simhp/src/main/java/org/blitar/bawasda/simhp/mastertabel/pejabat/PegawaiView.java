...
public class PegawaiView extends CustomComponent{
	private PegawaiModel model;
	...
	private ComboBox comboGrup = new ComboBox("JABATAN");
	private TextField fieldDescription= new TextField("NAMA");
	private CheckBox checkStatusActive = new CheckBox("AKTIF", false);
	
	private TextField fieldAddress= new TextField("Alamat");
	private TextField fieldCity= new TextField("Kota");
	private TextField fieldPostCode= new TextField("Kode Pos");
	private TextField fieldPhone= new TextField("Telp/HP");
	private TextField fieldNip= new TextField("NIP");
	private TextField fieldBornPlace= new TextField("Tempat Lahir");
	private TextField fieldGol= new TextField("Golongan");
	
	private DateField dateFieldBornDate = new DateField("Tanggal Lahir");
	...
	private ComboBox comboSearchByGrup = new ComboBox("JABATAN");
	private TextField fieldSearchById = new TextField("ID");
	private TextField fieldSearchByDesc = new TextField("NAMA");
	...
	public PegawaiView(PegawaiModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
	...
	public void initComponent(){
		...
		fieldNip.setNullRepresentation("");
		fieldAddress.setNullRepresentation("");
		fieldCity.setNullRepresentation("");
		fieldPostCode.setNullRepresentation("");
		fieldPhone.setNullRepresentation("");
		fieldBornPlace.setNullRepresentation("");
...
//		layoutTop.setComponentAlignment(fieldSearchByRefno, Alignment.BOTTOM_CENTER);
		...
		formLayout.addComponent(fieldNip);
		
		formLayout.addComponent(fieldAddress);
		formLayout.addComponent(fieldCity);
		formLayout.addComponent(fieldPostCode);
		formLayout.addComponent(fieldPhone);
		formLayout.addComponent(fieldBornPlace);
		formLayout.addComponent(dateFieldBornDate);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		model.getBinderHeader().bind(fieldDescription, "name");
		model.getBinderHeader().bind(fieldNip, "nip");
		model.getBinderHeader().bind(comboGrup, "pegawaiJabatanBean");
		model.getBinderHeader().bind(fieldGol, "gol");
		model.getBinderHeader().bind(fieldAddress, "address");
		model.getBinderHeader().bind(fieldCity, "city");
		model.getBinderHeader().bind(fieldPostCode, "postcode");
		model.getBinderHeader().bind(fieldPhone, "phone");
		model.getBinderHeader().bind(fieldBornPlace, "bornplace");
		model.getBinderHeader().bind(dateFieldBornDate, "bornDate");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "name","nip", "address", "city", "pegawaiJabatanBean", 
				"statusActive");
...
//		table.setColumnAlignment("amountused", Align.RIGHT);
		...
		table.setColumnHeader("nip", "NIP");
		table.setColumnHeader("address", "ALAMAT");
		table.setColumnHeader("city", "KOTA");
		table.setColumnHeader("pegawaiJabatanBean", "GRUP");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public void setModel(PegawaiModel model) {
		this.model = model;
	}
