...
public class TabelTemuanGrupView extends CustomComponent{
	...
	public TabelTemuanGrupView(TabelTemuanGrupModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		layoutTop.setComponentAlignment(fieldSearchByRefno, Alignment.BOTTOM_CENTER);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		model.getBinderHeader().bind(comboGrup, "temuanKelompokBean");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "temuanKelompokBean", 
				"statusActive");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("temuanKelompokBean", "KELOMPOK");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelTemuanGrupModel getModel() {
		return model;
	}

	public void setModel(TabelTemuanGrupModel model) {
		this.model = model;
	}
