...
public class TabelRekomendasiGrupView extends CustomComponent{
	private TabelRekomendasiGrupModel model;
	...
	public TabelRekomendasiGrupView(TabelRekomendasiGrupModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		comboGrup.setNullSelectionAllowed(false);
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "statusActive");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelRekomendasiGrupModel getModel() {
		return model;
	}

	public void setModel(TabelRekomendasiGrupModel model) {
		this.model = model;
	}
