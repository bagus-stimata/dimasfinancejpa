...
public class SuratTugasTimAnggotaPosisiView extends CustomComponent{
	...
	private TextField fieldDescription= new TextField("POSISI/JABATAN");
	...
	private TextField fieldSearchByDesc = new TextField("POSISI/JABATAN");
	...
	public SuratTugasTimAnggotaPosisiView(SuratTugasTimAnggotaPosisiModel model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("description", "POSISI/JABATAN");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public SuratTugasTimAnggotaPosisiModel getModel() {
		return model;
	}

	public void setModel(SuratTugasTimAnggotaPosisiModel model) {
		this.model = model;
	}
