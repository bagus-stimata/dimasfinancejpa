...
public class TabelLembagaTk2View extends CustomComponent{
	...
	private ComboBox comboGrup = new ComboBox("LEMBAGA TK I");
	private TextField fieldDescription= new TextField("LEMBAGA TK II");
	private CheckBox checkHasChild = new CheckBox("Mempunyai Lembaga Tk III", false);
	...
	private ComboBox comboSearchByGrup = new ComboBox("LEMBAGA TK I");
	private TextField fieldSearchById = new TextField("ID");
	private TextField fieldSearchByDesc = new TextField("LEMBAGA TK II");
	...
	public TabelLembagaTk2View(TabelLembagaTk2Model model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		layoutTop.setComponentAlignment(fieldSearchByRefno, Alignment.BOTTOM_CENTER);
		...
		formLayout.addComponent(checkHasChild);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		model.getBinderHeader().bind(comboGrup, "lembagaTk1Bean");
		model.getBinderHeader().bind(checkHasChild, "hasTkIII");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "lembagaTk1Bean", 
				"hasTkIII");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("lembagaTk1Bean", "GRUP");
		table.setColumnHeader("hasTkIII", "Punya Tk III");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelLembagaTk2Model getModel() {
		return model;
	}

	public void setModel(TabelLembagaTk2Model model) {
		this.model = model;
	}
