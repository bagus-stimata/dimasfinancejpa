...
public class TabelLembagaTk3View extends CustomComponent{
	...
	private ComboBox comboGrup = new ComboBox("LEMBAGA TK II");
	private TextField fieldDescription= new TextField("LEMBAGA TK III");
	...
	private ComboBox comboSearchByGrup = new ComboBox("LEMBAGA TK II");
	private TextField fieldSearchById = new TextField("ID");
	private TextField fieldSearchByDesc = new TextField("LEMBAGA TK III");
	...
	public TabelLembagaTk3View(TabelLembagaTk3Model model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		formLayout.addComponent(checkStatusActive);
	...
	public void bindAndBuildFieldGroupComponent(){
		...
		model.getBinderHeader().bind(comboGrup, "lembagaTk2Bean");
//		model.getBinderHeader().bind(checkStatusActive, "statusActive");
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "lembagaTk2Bean");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("description", "LEMBAGA TK III");
		table.setColumnHeader("lembagaTk2Bean", "TK II");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelLembagaTk3Model getModel() {
		return model;
	}

	public void setModel(TabelLembagaTk3Model model) {
		this.model = model;
	}
