...
public class TabelLembagaTk1View extends CustomComponent{
	private TabelLembagaTk1Model model;
	...
	private TextField fieldDescription= new TextField("LEMBAGA TK I");
	private CheckBox checkHasChild = new CheckBox("Mempunyai TK II", false);
	...
	private TextField fieldSearchByDesc = new TextField("LEMBAGA TK I");
	...
	public TabelLembagaTk1View(TabelLembagaTk1Model model){
		this.model = model;
		initComponent();
		buildView();
		initComponentState();
...
//		comboGrup.setNullSelectionAllowed(false);
		...
		model.getBinderHeader().bind(checkHasChild, "hasTkII");		
	...
	public void setTableProperties(){
		...
		setVisibleTableProperties("id", "description", "hasTkII");
...
//		} catch(Exception ex){}
		...
		table.setColumnHeader("description", "NAMA LEMBAGA");
		table.setColumnHeader("hasTkII", "Punya TK II");
...
//		table.setColumnExpandRatio("recapno", 3);
	...
	public TabelLembagaTk1Model getModel() {
		return model;
	}

	public void setModel(TabelLembagaTk1Model model) {
		this.model = model;
	}
	...
	public CheckBox getCheckHasChild() {
		return checkHasChild;
	}

	public void setCheckHasChild(CheckBox checkHasChild) {
		this.checkHasChild = checkHasChild;
	}
